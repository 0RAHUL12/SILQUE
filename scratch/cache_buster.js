...
const targetVersion = '20260607-dipti-chatbot-v7';
...
const run = () => {
  ...
  htmlFiles.forEach((file) => {
    ...
    if (content.includes('site.css?v=20260607-dipti-chatbot-v6')) {
      content = content.replace('site.css?v=20260607-dipti-chatbot-v6', `site.css?v=${targetVersion}`);
      modified = true;
    }
    ...
    if (content.includes('site.js?v=20260607-dipti-chatbot-v6')) {
      content = content.replace('site.js?v=20260607-dipti-chatbot-v6', `site.js?v=${targetVersion}`);
      modified = true;
    }
